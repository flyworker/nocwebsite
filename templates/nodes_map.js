...
{% for node in nodes %}
    map.addMarker({
      ...
      icon: 'https://maps.google.com/mapfiles/ms/icons/{% if node.state == "maintenance" %}red{% endif %}{% if node.state == "live" %}green{% endif %}{% if node.state == "inprogress" %}blue{% endif %}-dot.png',
      infoWindow: {
